#############################################################################
# Makefile for building: kingcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: ??? ?? 16 00:27:12 2014
# Project:  kingcoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_UPNP=- -o Makefile kingcoin-qt.pro
#############################################################################
...
Makefile: kingcoin-qt.pro  ../../Qt/4.8.5/mkspecs/win32-g++/qmake.conf ../../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile kingcoin-qt.pro
