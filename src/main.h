...
static const int64 MAX_MONEY = 52560000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 288 / 250; // 288 blocks found a day. Priority cutoff is 1 KING day / 250 bytes.
    }
