...
uint256 hashGenesisBlock("0xfe46dcd1198fcb995f5cf82c24b18a8215909a2f1d7dc916ddc929410bccf3fa");
...
const string strMessageMagic = "kingcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // kingcoin: 1 days
static const int64 nTargetSpacing = 300; // kingcoin: 5 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal kingcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "kingcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe826d0ce11612e0e47eddc2e9081b78b5c428a665c2ebc3c61d7021bf03a1d90");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "62 dogs crammed into minivan";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389845071;//1369623856; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3507992;

        if (fTestNet)
        {
            block.nTime    = 1389802328; 
            block.nNonce   = 1903584;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x330c2510b9291982ae5cc44af68d96f2f8df33f16c1eaf34e50344287e49de8a"));
